  ...
  this.projects = [
    {
      ...
      target: 7,
      people: [],
      bugs: ["658368 Expand console object with time and timeEnd methods", "655700 More visual separation between requests", "656231 cleanup the HUD object properties", "656709 Net toggle isn't tab-specific", "657940 should be smarter about really long strings", "657932 lack of symmetry in handling of enter and escape keys"]
    }, {
      id: "tilt",
      name: "Tilt",
