  ...
  this.projects = [
    {
      ...
      target: 7,
      people: ["mratcliffe"],
      bugs: ["574347 Opening the HUD with Inspector open causes Style Panel to move", "582596 Style view answering common CSS questions", "583037 Better logic for placement of inspector panels", "585563 The inspector style panel should link to the CSS editor", "586974 All unmatched rules are ranked the same", "586977 Investigate how the panel works with shorthand properties", "587752 Animations in the new Style panel", "588941 Computed style for property is sometimes wrong", "589264 Add option to choose an alternative media type", "589375 Keyboard access", "590536 Inspector panels should remember at least size and ideally also position", "590796 Clicking on a rule doesn't jump to the correct line in the CSS editor", "591212 React to dynamic changes to the stylesheets", "591582 Style Panel CSS properties are limited to hard coded values", "591584 Localize the URLs in csshtmltree", "591902 Automatic display of localized content", "593331 Csslogic shortSource can create duplicate names", "593345 Investigate an advanced test tool for the inspector style panel", "652509 Style inspector should skip unsupported styles", "653082 Stylesheet selector should be removed", "653084 Specificity should be removed", "654068 Show visual indicator when there are unmatched rules but not matched rules", "654069 \"Effects and Other\" group should be extracted into more than 1 group", "654430 Unmatched rules do not work for string values", "656027 It should be possible to pref out the Style Inspector", "586984 [meta] Inspector style panel bugs for firefox4", "592981 [meta] Inspector style panel bugs for firefox.next"]
    }, {
      id: "webconsole6",
